...
\begin{multline}
 ...
 \frac1{(\omega - \epsilon_{k,b} + \tilde\omega_0^<)^2 + \Gamma_{k,b}^2}  \\ 
  + \frac12 \sum_{j=1}^{N^<} \biggl[ \frac{(a_i + \beta_{k,b}^>)^2 - a_i^2 }
 ...
 \biggr] \biggr\} \\
 + \frac12 \frac{(a_i + \beta_{k,b}^>)^2 - a_i^2}{(\omega - \epsilon_{k,b} + 2 \tilde\omega_0^<)^2 + \Gamma_{k,b}^2} 
 + \frac16 \frac{(a_i + \beta_{k,b}^>)^3 - a_i^3}{(\omega - \epsilon_{k,b} + 3 \tilde\omega_0^<)^2 + \Gamma_{k,b}^2} 
 \Biggr) \\
